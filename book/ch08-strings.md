...
Սի լեզվում _տողը_ նիշերի (character) միաչափ զանգված է, որի վերջին տարրն
...
բայց կօգտագործի ցուցիչների հետ կատարվող թվաբանություն։
    ...
    size_t strlen1( const char* s )
    {
      ...
      while( _++p != '\0' );  /_ քանի դեռ p-ն \0 նիշի վրա չէ, առաջ տանել այն */
...
Եթե պետք է մի տողին _կցել_ մեկ այլ տողի պարունակություն, ապա
...
Տողերը _համեմատվում_ են ֆունկցիայով։ Այս ֆունցկիան կատարում է
արգումենտում տրված երկու տողերի _բառարանային_ համեմատում։ Եթե երկու
...
`␣␣␣304\0` տեսքը։ (Այստեղ `␣` նիշն օգտագործել եմ _բացատ_ նիշի դիրքերը
ցույց տալու համար։)
