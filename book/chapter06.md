...
որևէ տարրին կարելի է դիմել *ինդեքսավորման* գործողությամբ, զրոյից սկսվող
...
Սի լեզվում զանգվածի անունը *ցուցիչ* է իր առաջին տարրին, իսկ զանգվածի
...
ստանում ցիկլի հաշվիչը։ Այնուհետև, քանի դեռ *կեղծ է* արտահայտության
...
Արժեքի *ավելացման* `++` (increment) գործողությունը Սի լեզվում հանդես է
գալիս *նախածանցային* (prefix) և *վերջածանցային* (postfix) տեսքերով։
...
Բեկյալի երկարությունը հաշվող *length* ֆունկցիան, որ սահմանեցի վերևում,
նույնպես կարող եմ գրել ցիկլի օգնությամբ։ \[Բայց պիտի ասեմ, որ ռեկուրսիվ
իրականացումն ինձ ավելի *գեղեցիկ* է թվում։\]
...
նիշով ավարտվող *բլոկի* մեջ։ Պետք է նշել, որ բլոկում սահմանված փոփոխականը
